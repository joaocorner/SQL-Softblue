...
FROM
    funcionarios f
    LEFT JOIN veiculos v ON v.funcionario_id = f.id;

SELECT
    *
FROM
    funcionarios f
    RIGHT JOIN veiculos v ON v.funcionario_id = f.id;
...
INSERT INTO
    veiculos (funcionario_id, veiculo, placa)
VALUES
    (null, "Moto", "SB-0003");
...
SELECT
    a.nome AS CLIENTE,
    b.nome AS "QUEM INDICOU"
FROM
    clientes a
    join clientes b ON a.quem_indicou = b.id;
